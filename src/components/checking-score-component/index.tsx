...
import { View, Text, StyleProp, ViewStyle, ImageStyle, TextStyle } from 'react-native';
      ...
      return (
        <>
          ...
          <Text style={styles.titleTextStyle}>
            {i18n?.t('credit_check.lbl_credit_pending') ?? 'Credit Check Pending'}
          </Text>
            ...
            >
              {(_) => (
                <View>
                  ...
                  <Text style={styles.scoreValueTextStyle}>{creditScore.ficoScore}</Text>
                </View>
              )}
            </AnimatedCircularProgress>
            <Text style={styles.titleTextStyle}>
